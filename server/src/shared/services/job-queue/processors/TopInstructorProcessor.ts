import { IRefreshTopInstructorsUseCase } from '../../../../modules/admin/application/interfaces/IRefreshTopInstructorsUseCase';
  ...
  private initializeProcessor() {
    jobQueueService.processJob(
      ...
      async (_job: Queue.Job) => {
        ...
        await this.refreshTopInstructorsUseCase.execute();
      },
    );
  }
}
