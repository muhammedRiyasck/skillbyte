...
router.post("/login", CustomLimit(10, 'login'), requireRole('student', 'instructor'), asyncHandler(commonAuthController.login));
...
router.post('/resend-otp', CustomLimit(10, 'resend OTP'), asyncHandler(commonAuthController.resendOtp));
router.post('/forgot-password', CustomLimit(10, 'forgot password'), asyncHandler(commonAuthController.forgotPassword));
router.post('/reset-password', CustomLimit(10, 'reset password'), asyncHandler(commonAuthController.resetPassword));
