            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="group flex gap-4 p-4 bg-slate-50 dark:bg-white/5 hover:bg-slate-100 dark:hover:bg-white/10 rounded-2xl border border-slate-100 dark:border-white/5 transition-colors">
                  ...
                  <div>
                    <p className="text-sm font-bold text-slate-900 dark:text-white mb-0.5">Persistence Policy</p>
                    <p className="text-xs text-slate-500 dark:text-gray-400 leading-relaxed">Ensure a stable connection. Your progress and score are finalized only after manual submission.</p>
                  </div>
                </div>
