...
import { ChevronLeft, ChevronRight, Send, HelpCircle, BrainCircuit, ArrowLeft, Settings, Code2 } from 'lucide-react';
...
// add scrollto top when user clic  ks prev or next question button
  useEffect(() => {
    window.scrollTo(0, 0);
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <div className="text-right hidden sm:block">
              <p className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase">Question Progress</p>
            ...
            <button
              ...
              className="px-5 py-2.5 text-sm font-semibold text-indigo-600 bg-white dark:bg-gray-700 border border-indigo-100 dark:border-gray-600 rounded-xl hover:bg-indigo-50 dark:hover:bg-gray-600 shadow-sm transition-all cursor-pointer flex items-center gap-2"
            >
            ...
            {questions.map((_, idx) => {
              ...
              return (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 cursor-pointer flex-1 min-w-[8px] ${
                    isActive
                  ...
                  {currentQuestion.type === 'mcq' && currentQuestion.options?.map((option: string, index: number) => {
                    ...
                    return (
                      <button
                        ...
                        className={`group w-full text-left p-4 md:p-5 rounded-2xl border-2 transition-all duration-200 flex items-center gap-4 cursor-pointer ${
                          isSelected 
                      ...
                      >
                        <div className={`w-8 h-8 rounded-lg flex items-center justify-center border-2 font-bold transition-all shrink-0 ${
                          isSelected 
                  ...
                  {currentQuestion.type === 'true_false' && (
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <button
                        ...
                        className={`group p-8 rounded-2xl border-2 text-center transition-all duration-200 cursor-pointer ${
