  ...
  return (
    <div className="p-6 min-h-screen bg-gray-400/20 dark:bg-gray-800">
      ...
      <div className="overflow-x-auto rounded-lg shadow-md bg-gray-150 ">
        {loading?<InstructorRequestShimmer/>:<table className="w-full border-collapse  ">
          <thead>
          ...
          {!instructors?<p className="text-2xl text-red-800 text-center my-8">No Data Found</p>:<tbody>
            {instructors.map((inst) => (
              <tr key={inst._id} className="border-b border-gray-300 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-700 dark:text-blue-100">
