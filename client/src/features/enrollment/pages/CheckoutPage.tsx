...
export const CheckoutPage: React.FC = () => {
    ...
    const initializeStripePayment = async () => {
        ...
        try {
            const paymentData = await initiateEnrollmentPayment(id, 'stripe');
    ...
    if (!course) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 text-gray-500 dark:text-gray-400">
                ...
                back to &nbsp;<Link to={ROUTES.course.details.replace(':id', id!)} className="text-indigo-600 hover:underline">course page</Link> .
            </div>
        );
    }
                            ...
                            <div className="p-8">
                                ...
                                <div className="flex gap-4 mb-8">
                                    <button
                                        ...
                                        className={`flex-1 flex items-center justify-center gap-2 p-4 rounded-xl border-2 transition-all duration-200 cursor-pointer ${paymentMethod === 'stripe'
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 flex items-center justify-center gap-2 p-4 rounded-xl border-2 transition-all duration-200 cursor-pointer ${paymentMethod === 'paypal'
                                                ? 'border-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400'
                                                : 'border-gray-200 dark:border-gray-700 text-gray-500 hover:border-gray-300'
                                            }`}
                                    >
