...
const Dashboard: React.FC = () => {
  ...
  const itemsPerPage = 5; // Reduced for better pagination visibility
  ...
  const fetchEnrollments = async (page: number) => {
    try {
      setLoading(true);
      setError(null);
      const data = await getInstructorEnrollments(page, itemsPerPage);
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-800 p-6 flex flex-col">
      <div className="max-w-7xl mx-auto w-full flex-grow flex flex-col">
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 ">
              View all student enrollments for your courses
            </p>
          </div>
          <button
            onClick={() => {
        ...
        {enrollments.length === 0 ? (
          <div className="text-center py-12 flex-grow flex flex-col justify-center">
            ...
            <h3 className="text-xl font-medium text-gray-50 dark:text-gray-400 mb-2">
              No Enrollments Yet
            </h3>
          ...
          <>
            <div className="space-y-8 flex-grow">
              {enrollments.map((course) => (
                <div
                  key={course.courseId}
                  className="bg-white dark:bg-gray-700 rounded-xl shadow-sm border border-gray-200 overflow-hidden"
                >
                  {/* Course Header */}
                  ...
                  {/* Students List */}
                  <div className="p-6">
                    <h3 className="text-lg font-semibold dark:text-gray-50 mb-4">
                      Enrolled Students
                    </h3>
                    <div className="space-y-4">
                      {course.enrollments.map((enrollment) => (
                        <div
                          ...
                          className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 border border-gray-200"
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                              <div>
