            ...
            <div className="space-y-1 ">
              ...
              >
                ...
                {enrollments.map(course => (
                  <option className='cursor-pointer' key={course.id} value={course.id}>{course.courseTitle}</option>
                ))}
              </select>
            </div>
        ...
        {enrollments.length === 0 ? (
          ...
          <>
            <div className="space-y-8 flex-grow">
              {enrollments.map((course) => (
                <div key={course.id} className="bg-white dark:bg-gray-700 rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                  {/* Course Header */}
                ...
                <div className="flex items-center gap-1">
                  {[...Array(totalPages)].map((_, i) => (
                    <button
                      ...
                      className={`w-10 h-10 rounded-lg border cursor-pointer ${currentPage === i + 1
