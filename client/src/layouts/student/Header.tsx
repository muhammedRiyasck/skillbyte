          ...
          <div className="flex items-center justify-between  md:px-8  bg-gray-50 border-b border-gray-200 px-4 dark:bg-gray-900 shadow-2xl dark:border-b dark:border-gray-700 dark:text-white">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className="border border-gray-400 dark:border-gray-500 text-sm lg:text-lg px-5 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 hover:cursor-pointer"
              >
                Sign Out
              </button>
              <ThemeToggle />
